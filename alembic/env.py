...
# Load the app metadata + every model module so autogenerate sees the full schema.
from app.database import Base, DATABASE_URL
import app.models.models       # noqa: F401
import app.models.clevel       # noqa: F401
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        # SQLite needs batch mode for ALTER operations; harmless on Postgres.
